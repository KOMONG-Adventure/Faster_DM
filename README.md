...
### v0.5.1 — 503 / 429 үед сэргээх

- Файлын нэр тодорхойлох хүсэлт түр алдахад 3 хүртэл дахин оролдоно (нийт 90 секундийн хязгаартай).
- HTTP хэсэг 503/429 буцаавал бусад worker-ийг бүрэн зогсоож, хадгалсан offset-ийг үлдээн холболтыг таллан бууруулна; хамгийн багадаа 1 холболт.
- Retry-After-ийг дагана; байхгүй үед нэмэгдэх хүлээлт + санамсаргүй нэмэлт хугацаа ашиглана. Дахин оролдох хүртэлх секундийг UI харуулна.
- Гараар 1 эсвэл 2 холболт сонгох боломжтой. Түр зогсоосон таталтыг цуцлахгүйгээр аппын шинэчлэлт суулгаж болно.
- Сервер өөрөө боломжгүй, IP/эрх хязгаарласан бол амжилтыг батлахгүй; алдаа болон хэсгүүдийг хадгална.

### v0.5.0 — үргэлжлүүлэлт, дараалал, түүх

- Апп хаасны дараа **Үргэлжлүүлэх** товчоор таталтаа сэргээнэ. HTTP Range + strong ETag дэмжсэн серверт баталгаажуулсан хэсгүүдээс үргэлжилнэ. Серверийн файл өөрчлөгдвөл алдаа харуулна; **Дахин татах** нь шинэ таталт үүсгэнэ.
- HTTP хэсгүүдийн manifest-ийг 5 секунд тутам, зогсох үед өгөгдлийг Sync хийсний дараа атомикаар хадгална. Crash бол хамгийн сүүлийн checkpoint-оос хойших хэдэн секундын өгөгдлийг дахин татаж болно. Range/strong ETag байхгүй бол эхнээс нь татна.
- YouTube-ийн ажлын хавтас хадгалагдаж, yt-dlp --continue ашиглана. Эх видеоны хүртээмж, формат өөрчлөгдвөл үргэлжлүүлэлт амжилтгүй байж болно.
- **Таталтын тохиргоо**: зэрэг 1–4 файл (анхдагч 2), бусад нь дараалалд орно. Түр зогсоох нь дараагийн таталтад зай гаргана. Апп дахин нээхэд автоматаар сүлжээ ашиглахгүй; хадгалсан таталтыг гараар үргэлжлүүлнэ.
- Нэг файлын бүх холболтын **нийлбэр хурдны хязгаар**: MiB/s, 0 = хязгааргүй. YouTube мөн хязгаарлана. Өөрчлөлт дараагийн эхлэх/үргэлжлүүлэх таталтад үйлчилнэ; нийт сүлжээний хязгаар биш. TCP buffering болон богино хугацааны burst гарч болно.
- Түүхээс арилгах нь татсан файлыг устгахгүй; дахин нээхэд арилгасан мөр буцаж импортлогдохгүй. Файл нээх, хавтас нээх, дахин татах, алдаатай таталтыг үргэлжлүүлэх боломжтой. Байхгүй файлыг апп нээх үед тэмдэглэнэ.
- Дууссан/алдаатай таталтын апп доторх болон Windows мэдэгдэл; тохиргоогоор унтраана. Windows-ийн мэдэгдлийн тохиргоо, Do Not Disturb нь toast харагдахад нөлөөлнө.
- Шинэ хувилбарын таталтын эх холбоосыг хувийн history JSON-д хадгална. Хугацаатай холбоос хүчингүй бол шинэ холбоосоор шинэ таталт эхлүүлнэ. Өмнөх хувилбарын хэсгүүд/хадгалаагүй холбоосыг нөхөж сэргээхгүй.

### Таталтын түүх

v0.4.2-оос таталт эхлэх болон дуусах үед түүхийг
`%APPDATA%\FasterDM\history` дотор тусдаа JSON файлаар хадгална. Апп дахин
нээхэд нэр, хэмжээ, байрлал, төлөв, татсан хугацааг сэргээнэ. Шинэчлэлт болон
installer устгал нь энэ хавтас болон татсан файлуудыг устгахгүй.

Хуучин хувилбарын `Downloads\Faster DM` ангилсан хавтаснууд дахь бэлэн файлуудыг
автоматаар импортлоно; давхар бүртгэл, `.part`, symlink файлыг алгасана.
Импортолсон файлын татсан хугацаа тодорхойгүй тул `—` харуулна. Өөрийн сонгосон
бусад хавтас дахь хуучин файлуудыг автоматаар хайхгүй.

v0.5.0-оос эх холбоос, хэсгүүдийг хадгалж үргэлжлүүлнэ. Өмнөх хувилбарын дуусаагүй таталт тасарсан төлөвтэй байна. Гэмтсэн түүхийн бичлэгийг устгахгүй,
алдааг харуулж, бусад түүхийг ачаална.

### Хуулсан холбоос автоматаар оруулах

**Хуулсан холбоосыг автоматаар оруулах** тохиргоо анхдагчаар асаалттай.
HTTP/HTTPS холбоос хуулаад апп руу ороход хоосон талбарт автоматаар орно.
Өмнөх автоматаар орсон холбоос шинэ хуулсан холбоосоор солигдоно; гараар
бичиж буй холбоосыг дарахгүй. **Хуулсан холбоос оруулах** товчоор хүссэн үедээ
оруулж болно. Таталт зөвхөн **Татаж эхлэх** дарахад эхэлнэ.
Тохиргоог унтрааж болно. Clipboard-ийн холбоосоос бусад текстийг frontend рүү
дамжуулахгүй, хуулсан холбоосыг шалгах гэж серверт хүсэлт явуулахгүй.
Tray-ээс буцаж нээхэд хуулсан холбоосыг авна; апп өөрөө гэнэт урд гарч ирэхгүй.
...
- Аппын анхны нээлтэд Монгол хэлтэй Driver.js танилцуулга автоматаар гарна.
  ...
  **Заавар** товчоор хэдийд ч дахин үзэж болно.
- v0.4.1-д наргианы булан, уриа, давхардсан тайлбаруудыг авч UI-г товчилсон.
...
**Pause/resume:** апп хааж нээхэд мөн ажиллана. HTTP Range + strong ETag
...
Таталтын түүх болон үргэлжлүүлэлтийн мэдээлэл хадгалагдана.
...
- Цуцлах товч partial файлыг цэвэрлэнэ. Хаах/түр зогсоох/алдаа нь хадгална; түүхээс арилгахад үлдэгдэл partial-ийг мөн цэвэрлэнэ.
